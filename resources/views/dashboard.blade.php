    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                {{-- れいぞうこ --}}
                <div class="lg:w-5/12 mx-auto pt-10 pb-5">
                    {{-- 枠 --}}
                ...
                <a href="{{ route('items.create') }}" class="mt-5 flex justify-center w-5/12 lg:w-3/12 mx-auto">
                    <button class="bg-yellow-400 hover:bg-yellow-500 border-4 border-orange-300 text-white text-lg lg:text-xl font-bold tracking-wider py-2 px-4 rounded-lg mb-10">食材のとうろく</button>
                </a>
                ...
                <div class="my-5 lg:w-6/12 mx-auto relative">
                    <img src="/images/memo.png" class="block mx-auto">
                    <textarea name="memo" id="memo" cols="30" rows="2" placeholder="次の買い物で買うものなどをメモできます。" class="absolute resize-none top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-8/12 border-2 border-gray-200 p-2 rounded">{{ $memo->memo }}</textarea>
